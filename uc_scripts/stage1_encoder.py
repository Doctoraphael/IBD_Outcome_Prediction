...
def main():
    parser = argparse.ArgumentParser(description="Stage1: GastroNet-5M Encoder Pretraining")
    ...
    print("=" * 80)
    print("Stage 1: GastroNet-5M Encoder预训练 - 异常图像分类")
    print("=" * 80)
    ...
    ds_tr = UCImageDataset(trn_img, train_tf)
    ds_va = UCImageDataset(val_img, eval_tf)
    ds_te = UCImageDataset(test_img, eval_tf)
    ...
    ds_full = UCImageDataset(full_train_df, train_tf)
    ...
    try:
        ...
        hf_config = {
            ...
            "fine_tuned_on": "UC_endoscopy_images",
